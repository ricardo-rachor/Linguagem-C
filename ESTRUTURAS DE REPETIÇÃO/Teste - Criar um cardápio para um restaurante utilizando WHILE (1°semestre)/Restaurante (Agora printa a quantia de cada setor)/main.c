...
int main()
{
    ...
    char op;
    int x, op1, soma_e=0, soma_p=0, soma_s=0, soma_b=0, cont_e=0, cont_p=0, cont_s=0, cont_b=0;
    ...
    if (soma_e>0)
      printf("\n\n %d Entradas = R$%d", soma_e, cont_e);

    if (soma_p>0)
      printf("\n %d Pratos Principais = R$%d", soma_p, cont_p);

    if (soma_s>0)
      printf("\n %d Sobremesas = R$%d ", soma_s, cont_s);

    if (soma_b>0)
      printf("\n %d Bebidas = R$%d", soma_b, cont_b);
